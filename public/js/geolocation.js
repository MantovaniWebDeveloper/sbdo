...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#ricercaGeo').on('click', function () {
    ...
    opencage.geocode({
      ...
      if (data.status.code == 200) {
        if (data.results.length > 0) {
          ...
          console.log(place.components.county); //$('#select2-search__field').val(place.components.village);

          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.citta-input').prop("disabled", true);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#citiesNascosto').show();
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#citiesNascosto').val(place.components.village);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#lat').val(latitudine);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#long').val(longitudine);
        }
...
module.exports = __webpack_require__(/*! /Users/dariomantovani/Desktop/progettiLaravel/stasera-balliamo/resources/js/geolocation.js */"./resources/js/geolocation.js");
